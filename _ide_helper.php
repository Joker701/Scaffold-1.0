 ...
 * Generated for Laravel 4.2.17 on 2015-03-01.
 *
...
namespace {
    ...
    class Cart extends \Moltin\Cart\Facade{
         ...
         * @static 
         */
        public static function contentsArray(){
            return \Moltin\Cart\Cart::contentsArray();
        }
         ...
         *
         * @param string $itemIdentifier The unique item identifier
         * @return \Moltin\Cart\Item Item object
         * @static 
         */
        ...
        public static function totalWithTax(){
            return \Moltin\Cart\Cart::totalWithTax();
        }
        ...
        public static function totalWithoutTax(){
            return \Moltin\Cart\Cart::totalWithoutTax();
        }
         ...
         * @static 
         */
        public static function totalUniqueItems(){
            return \Moltin\Cart\Cart::totalUniqueItems();
        }
        ...
        public static function setCurrency($currency){
            return \Moltin\Cart\Cart::setCurrency($currency);
        }
        
        /**
         * Get the currency object
         *
         * @return \Moltin\Cart\Currency The currency object for this cart
         * @static 
         */
    ...
    class BrainSocket extends \BrainSocket\BrainSocketFacade{
        ...
        public static function success($data = array()){
            return \BrainSocket\BrainSocketAppResponse::success($data);
        }
        ...
        public static function error($data = array()){
            return \BrainSocket\BrainSocketAppResponse::error($data);
        }
         ...
         * @static 
         */
        public static function message($event, $data = array()){
            return \BrainSocket\BrainSocketAppResponse::message($event, $data);
        }
